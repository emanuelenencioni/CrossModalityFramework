...
if __name__ == "__main__":
    ...
    folder1_path = os.path.join(dataset_folder.split("dataset")[0],"data/cityscapes/leftImg8bitEvents/train")
    folder2_path = os.path.join(dataset_folder.split("dataset")[0], "data/cityscapes/leftImg8bitEvents/val")
    output_txt_file1 = os.path.join(dataset_folder, "cs_train_events.txt")
    output_txt_file2 = os.path.join(dataset_folder, "cs_val_events.txt")
